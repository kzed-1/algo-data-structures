...
function linkedListIntersection(list1, list2) {
  ...
  let diff = Math.abs(linkedListLength(list1.head) - linkedListLength(list2.head))

  let long = list1.length >= list2.length? list1.head : list2.head
  let short = list1.length >= list2.length ? list2.head : list1.head
...
function linkedListLength(listNode){
